...
{
    public class ClassFuncionesTicket
    {
        ...
        public class CreaTicket
        {
            ...
            Image imageT;
            String text;
            public CreaTicket(Image imageT)
            {
                this.imageT = imageT;
                //this.text = text;
            }
            ...
            {
                string LineEncavesado = "Id Libro       Cant     P.Unit     Importe";   // 40 caracteres agrega lineas de  encabezados
            ...
            public void ImprimirTiket(string Impresora)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        printFont = new System.Drawing.Font("Arial", 10, FontStyle.Regular, GraphicsUnit.Pixel);
            ...
            public void pd_PrintPage(object sender, PrintPageEventArgs ev)
            {
                ...
                {
                    size = g.MeasureString(text, new Font("Arial", 10, FontStyle.Regular, GraphicsUnit.Pixel));
                }

                if ((int)size.Width < 53)
                {
                    leftMargin = 30;
                }

                if ((int)size.Width < 23)
                {
                    leftMargin = 40;
                }*/
                ...
                //ev.Graphics.DrawImage(imageT, new Rectangle(15, y += , 80, 80));
              ...
              //  linesPerPage = ev.MarginBounds.Height /
                ...
                ev.Graphics.DrawImage(imageT, new Rectangle(46, y += (int)yPos - 10 , 80, 80));
